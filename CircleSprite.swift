//
//  DroppingObject.swift
//  MatchOnDemand
//
//  Created by Yanbing Peng on 8/03/16.
//  Copyright © 2016 Apportable. All rights reserved.
//

import Foundation

class CircleSprite: CCSprite, FallingObjectProtocol {
    var numSprite : CCSprite!
    
    let objectShape : String = "Circle/"
    var objectColor : String = CONSTANTS.COLOR_RED.getAssociatedString()
    var number : Int = 1
    
    var objectAttributes = [String:String]()
    
    //MARK: -FallingObjectProtocol
    func setOjectColor(newColor:String){
        ...
        self.spriteFrame = CCSpriteFrame.init(imageNamed: (CONSTANTS.PATH_SHAPES.getAssociatedString() + CONSTANTS.SPRITE_CIRCLE_FOLDER.getAssociatedString() + newColor))
    }
