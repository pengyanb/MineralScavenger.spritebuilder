...
class RectangleSprite : CCSprite, FallingObjectProtocol{
    var numSprite : CCSprite!
    
    let objectShape : String = "Rectangle/"
    ...
    func setOjectColor(newColor:String){
        ...
        self.spriteFrame = CCSpriteFrame.init(imageNamed: (CONSTANTS.PATH_SHAPES.getAssociatedString() + CONSTANTS.SPRITE_RECTANGLE_FOLDER.getAssociatedString() + newColor))
    }
