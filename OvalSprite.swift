...
class OvalSprite: CCSprite, FallingObjectProtocol{
    var numSprite : CCSprite!
    
    let objectShape : String = "Oval/"
    ...
    func setOjectColor(newColor:String){
        ...
        self.spriteFrame = CCSpriteFrame.init(imageNamed: (CONSTANTS.PATH_SHAPES.getAssociatedString() + CONSTANTS.SPRITE_OVAL_FOLDER.getAssociatedString() + newColor))
    }
